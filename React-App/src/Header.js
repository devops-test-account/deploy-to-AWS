                        ...
                        <div class="col-lg-12 col-md-12" style={{textAlign:"left"}}>
                            ...
                            <div class="logo">
                                ...
                                <a href="#">
                                  ...
                                  <h3 style={{color:"#354F7E", marginBottom:"-30px",marginTop:"-40px"}}><img src={logo} style={{ marginRight:"20px"}} width="60px"/><span style={{marginTop:"-10px"}}>Chetu Farms Limited</span></h3>
